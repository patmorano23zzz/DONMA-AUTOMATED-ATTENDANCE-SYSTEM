  ...
  <ul class="sidebar-nav" data-coreui="navigation" data-simplebar>
    ...
    <li class="nav-item">
      <a class="nav-link<?= navActive('kiosk', $activePage) ?>" href="<?= $u ?>/kiosk.php">
        ...
        <span class="nav-label">Student Kiosk</span>
      </a>
    </li>
    ...
    <li class="nav-item">
      <a class="nav-link<?= navActive('attendance', $activePage) ?>" href="<?= $u ?>/attendance/records.php">
        ...
        <span class="nav-label">Attendance Records</span>
      </a>
    </li>
    ...
    <li class="nav-item">
      <a class="nav-link<?= navActive('students', $activePage) ?>" href="<?= $u ?>/students/list.php">
        ...
        <span class="nav-label">Student List</span>
      </a>
    </li>
    ...
    <li class="nav-item">
      <a class="nav-link<?= navActive('enroll-student', $activePage) ?>" href="<?= $u ?>/students/enroll.php">
        ...
        <span class="nav-label">Enroll Student</span>
        <?php if ($userRole === 'teacher'): ?>
        <span class="badge badge-sm bg-info ms-auto nav-badge">Needs Approval</span>
        <?php endif; ?>
      </a>
    </li>
    ...
    <li class="nav-item">
      <a class="nav-link<?= navActive('teacher-reports', $activePage) ?>" href="<?= $u ?>/teacher/reports.php">
        ...
        <span class="nav-label">My Class Report</span>
      </a>
    </li>
    <?php endif; ?>
    ...
    <li class="nav-item">
      <a class="nav-link<?= navActive('users', $activePage) ?>" href="<?= $u ?>/admin/users.php">
        ...
        <span class="nav-label">Users &amp; Teachers</span>
      </a>
    </li>
    ...
    <li class="nav-item">
      <a class="nav-link<?= navActive('pending-enrollments', $activePage) ?>" href="<?= $u ?>/admin/pending-enrollments.php">
        ...
        <span class="nav-label">Pending Enrollments</span>
        <?php if ($pendingCount > 0): ?>
        <span class="badge badge-sm bg-warning ms-auto nav-badge"><?= $pendingCount ?></span>
        <?php endif; ?>
      </a>
    </li>
    ...
    <li class="nav-item">
      <a class="nav-link" href="<?= $u ?>/authentication/logout.php">
        <svg class="nav-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
